 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = F:/PersonalProject/BLE-CC2541/BLE_Meeting/CC2640/examples/cc2650em/simple_peripheral/iar/config/configPkg/package/cfg/app_ble_prm3");
