 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = F:/PersonalProject/BLE-CC2541/BLE_Meeting/CC2640_NEW/examples/cc2650em/simple_central/iar/config/configPkg/package/cfg/app_ble_prm3");
