...
app_ble.xrm3: package/cfg/app_ble_prm3.orm3 
	...
	@$(MSG) lnkrm3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	LC_ALL=C $(iar.targets.arm.M3.rootDir)/bin/ilinkarm -o F:/PersonalProject/BLE-CC2541/BLE_Meeting/CC2640_NEW/examples/cc2650em/simple_central/iar/app/FlashROM/Exe/simple_central_cc2650em_app.out --map F:/PersonalProject/BLE-CC2541/BLE_Meeting/CC2640_NEW/examples/cc2650em/simple_central/iar/app/FlashROM/List/simple_central_cc2650em_app.map --config F:/PersonalProject/BLE-CC2541/BLE_Meeting/CC2640_NEW/examples/cc2650em/simple_central/iar/app/../../../../../src/common/cc26xx/iar/cc26xx_app.icf --keep __vector_table -f F:/PersonalProject/BLE-CC2541/BLE_Meeting/CC2640_NEW/examples/cc2650em/simple_central/iar/app/../config/configPkg/linker.cmd -f F:/PersonalProject/BLE-CC2541/BLE_Meeting/CC2640_NEW/examples/cc2650em/simple_central/iar/app/../config/iar_boundary.xcl F:/PersonalProject/BLE-CC2541/BLE_Meeting/CC2640_NEW/examples/cc2650em/simple_central/iar/app/../../../../../src/rom/common_rom_releases/03282014/common_rom.symbols C:/ti/tirtos_cc13xx_cc26xx_2_20_01_08/products/cc26xxware_2_24_02_17393/driverlib/bin/iar/driverlib.lib --entry __iar_program_start --vfe --silent -o $@ package/cfg/app_ble_prm3.orm3 -f package/cfg/app_ble_prm3.xdl  --semihosting=iar_breakpoint  --cpu=Cortex-M3 --map $(XDCCFGDIR)/$@.map  --redirect _Printf=_PrintfSmall --redirect _Scanf=_ScanfSmall 
