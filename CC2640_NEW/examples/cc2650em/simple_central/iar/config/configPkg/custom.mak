...
linker.cmd: package/cfg/app_ble_prm3.xdl
	$(SED) 's"^\"\(package/cfg/app_ble_prm3cfg.cmd\)\"$""\"F:/PersonalProject/BLE-CC2541/BLE_Meeting/CC2640_NEW/examples/cc2650em/simple_central/iar/config/configPkg/\1\""' package/cfg/app_ble_prm3.xdl > $@
