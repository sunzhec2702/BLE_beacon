...
app_ble.xrm3: package/cfg/app_ble_prm3.orm3 
	...
	@$(MSG) lnkrm3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	LC_ALL=C $(iar.targets.arm.M3.rootDir)/bin/ilinkarm -o C:/ti/simplelink/ble_sdk_2_02_01_18/examples/cc2650em/simple_peripheral/iar/app/FlashROM/Exe/cc2650em_app.out --config D:/IAR_Systems/Embedded_Workbench_8_0/arm/config/linker/TexasInstruments/cc26x0f128.icf --entry __iar_program_start --vfe --text_out locale --silent -o $@ package/cfg/app_ble_prm3.orm3 -f package/cfg/app_ble_prm3.xdl  --semihosting=iar_breakpoint  --cpu=Cortex-M3 --map $(XDCCFGDIR)/$@.map  --redirect _Printf=_PrintfSmall --redirect _Scanf=_ScanfSmall 
