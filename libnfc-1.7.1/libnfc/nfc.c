 ...
 * @param uiPollNr specifies the number of polling (0x01 ‚Ä? 0xFE: 1 up to 254 polling, 0xFF: Endless polling)
 * @note one polling is a polling for each desired target type
 * @param uiPeriod indicates the polling period in units of 150 ms (0x01 ‚Ä? 0x0F: 150ms ‚Ä? 2.25s)
